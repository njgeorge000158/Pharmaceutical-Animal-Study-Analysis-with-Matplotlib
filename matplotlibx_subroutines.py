...
#*******************************************************************************************
 #
 #  File Name:  matplotlibx_subroutines.py
 #
 #  File Description:
 #      This Python script, matplotlibx_subroutines.py, contains generic Python subroutines
...
CONSTANT_LOCAL_FILE_NAME = 'matplotlibx_subroutines.py'
...
#*******************************************************************************************
 #
 #  Subroutine Name:  display_linear_regression_line
 #
 #  Subroutine Description:
 #      This subroutine displays a linear regression line.
 #
 #
 ...
 #  series
 #          x_series
 #                          This parameter is the x-axis series.
 #  series
 #          y_series
 #                          This parameter is the y-axis series.
 #  float
 #          x_coordinate_float
 ...
 #  float
 #          alpha_float
 #                          This parameter is the alpha (transparency) value.  
 #  integer
 #          coefficient_precision_integer
 #                          This parameter is the equation coefficient precision. 
 #  float
 #          fontsize_float
 #                          This parameter is the equation's font size. 
 #  string
 #          fontweight_string
...
def display_linear_regression_line \
    ...
    try:
        ...
        (slope, intercept, rvalue, pvalue, stderr) \
            = stats.linregress(x_series, y_series)
        ...
        log_subroutines \
            .print_and_log_text \
                (f'The subroutine, display_linear_regression_line, '
...
#*******************************************************************************************
 #
 #  Subroutine Name:  display_polynomial_regression_line
 #
 #  Subroutine Description:
 #      This subroutine displays a single line chart from an x and y series and criteria.
 #
 #
 #  Subroutine Parameters:
 #
 ...
 #  integer
 #          degree_integer
 #                          This parameter is the regression polynomial degree.
 #  string
 #          line_color_string
 #                          This parameter is the line color.
 #  string
...
def display_polynomial_regression_line \
    ...
    try:
        ...
        polynomial_line_series \
            = regression_functions.return_polynomial_line_series(x_series, y_series)
        ...
        equation_label_string \
            = regression_functions.return_equation_as_string(model_equation_list)
        ...
        log_subroutines \
            .print_and_log_text \
                ('r-value:     {:.4f}'.format(r_value_float))
        
        log_subroutines \
            .print_and_log_text \
                ('r-squared:   {:.4f}'.format(r_value_float))
        
    except:
        
        log_subroutines \
            .print_and_log_text \
                (f'The subroutine, display_regression_line, '
                 + f'in source file, {CONSTANT_LOCAL_FILE_NAME},\n'
...
#*******************************************************************************************
 #
 #  Subroutine Name:  display_line_chart_from_xy_series
 #
 #  Subroutine Description:
 #      This subroutine displays a single line chart from an x and y series and criteria.
 #
 ...
 #  string
 #          marker_string
 #                          This parameter is the marker type.
 #  string
 #          marker_facecolor_string
 #                          This parameter is the marker face color.
 #  string
 #          markeredgecolor_string
...
def display_line_chart_from_xy_series \
    ...
    try:
        ...
        plt.xlabel \
            (x_label_string,
             fontdict \
                = {'fontsize': xlabel_fontsize_float,
        ...
        plt.ylabel \
            (y_label_string,
             fontdict \
                = {'fontsize': ylabel_fontsize_float,
        ...
        log_subroutines.save_plot_image(caption_string)
        ...
        log_subroutines \
            .print_and_log_text \
                (f'The subroutine, display_line_chart_from_xy_series, '
                 + f'in source file, {CONSTANT_LOCAL_FILE_NAME},\n'
                 + f'with the caption, {caption_string},\n'
                 + f'was unable to create a line chart.')
...
#*******************************************************************************************
 #
 #  Subroutine Name:  display_box_plot_from_series_list
 #
 #  Subroutine Description:
 #      This subroutine displays a box plot from a list of series.
 #
 #
 #  Subroutine Parameters:
 #
...
def display_box_plot_from_series_list \
    ...
    try:
        ...
        log_subroutines \
            .print_and_log_text \
                (f'The subroutine, display_box_plot_from_series_list, '
                 + f'in source file, {CONSTANT_LOCAL_FILE_NAME},\n'
                 + f'with the caption, {caption_string},\n'
                 + f'was unable to create a box plot.')
...
#*******************************************************************************************
 #
 #  Subroutine Name:  display_bar_chart_from_series
 #
 #  Subroutine Description:
 #      This subroutine displays a bar chart from a series.
 #
 #
 #  Subroutine Parameters:
 #
 ...
 #  float
 #          bar_width_float
 #                          This parameter is the bar width.
 #  float
 #          title_fontsize_float
 #                          This parameter is the title font size. 
 #  string
 ...
 #                          This parameter is the y-axis space pad value. 
 #  float
 #          xtick_label_rotation_float
 #                          This parameter is the x-axis tick rotation. 
 #  float
 #          xtick_fontsize_float
 #                          This parameter is the x-axis tick font size.
 #  float
 #          ytick_label_rotation_float
 #                          This parameter is the y-axis tick rotation. 
 #  float
 #          ytick_fontsize_float
 #                          This parameter is the y-axis tick font size. 
 #  float
 #          figure_width_float
 #                          This parameter is the figure width. 
...
def display_bar_chart_from_series \
    ...
    try:
        ...
        log_subroutines \
            .print_and_log_text \
                (f'The subroutine, display_bar_chart_from_series, '
                 + f'in source file, {CONSTANT_LOCAL_FILE_NAME},\n'
                 + f'with the caption, {caption_string},\n'
                 + f'was unable to plot a bar chart.')
...
#*******************************************************************************************
 #
 #  Subroutine Name:  display_bar_chart_from_dataframe
 #
 #  Subroutine Description:
 #      This subroutine displays a bar chart from a dataframe.
 #
 #
 #  Subroutine Parameters:
 #
 ...
 #  boolean
 #          stacked_boolean
 #                          This parameter indicates whether the bar chart is stacked.
 #  boolean
 #          legend_boolean
 #                          This parameter indicates whether the legend is present.
 #  float
 #          bbox_to_anchor_x_float
 #                          This parameter is the legend x-coordinate.  
 #  float
 #          bbox_to_anchor_y_float
...
def display_bar_chart_from_dataframe \
    ...
    try:
        ...
        log_subroutines \
            .print_and_log_text \
                (f'The subroutine, display_bar_chart_from_dataframe, '
                 + f'in source file, {CONSTANT_LOCAL_FILE_NAME},\n'
                 + f'with the caption, {caption_string},\n'
                 + f'was unable to plot a bar chart.')
...
#*******************************************************************************************
 #
 #  Subroutine Name:  display_scatter_plot_from_xy_series
 #
 #  Subroutine Description:
 #      This subroutine displays a scatter plot from x-y series.
 #
 #
 #  Subroutine Parameters:
 #
 ...
 #  integer
 #          degree_integer
 #                          This parameter is the degree of the regression line polynomial.
 #  float
...
def display_scatter_plot_from_xy_series \
    ...
    try:
        ...
        log_subroutines \
            .print_and_log_text \
                ('The subroutine, display_scatter_plot_from_xy_series, '
                 + f'in source file, {CONSTANT_LOCAL_FILE_NAME},\n'
                 + f'with the caption, {caption_string},\n'
                 + 'was unable to display a scatter plot.')
...
#*******************************************************************************************
 #
 #  Subroutine Name:  display_multiple_scatter_plots_from_xy_series_list
 #
 #  Subroutine Description:
 #      This subroutine displays multiple scatter plots from x-y series lists.
 #
 #
 #  Subroutine Parameters:
 #
 ...
 #  series
 #          x_series_list
 #                          This parameter is the x-axis series list.
 #  series
 #          y_series_list
 #                          This parameter is the y-axis series list.
 #  string
 #          titles_string_list
 ...
 #                          This parameter is the bar transparency level (0-1.0).
 #  float
 #          suptitle_fontsize_float
 #                          This parameter is the figure title font size. 
 #  string
 #          suptitle_fontstyle_string
...
def display_multiple_scatter_plots_from_xy_series_list \
    ...
    try:
        ...
        if scatter_plot_count_integer != len(y_series_list):
            ...
            log_subroutines \
                .print_and_log_text \
                    ('The subroutine, display_multiple_scatter_plots_from_xy_series_list, '
                     + f'in source file, {CONSTANT_LOCAL_FILE_NAME},'
                     + f'with the caption, {caption_string},'
        ...
        x_length_integer, y_length_integer \
            = mathx_functions.calculate_closest_factors(scatter_plot_count_integer)
        ...
        log_subroutines \
            .print_and_log_text \
                (f'The subroutine, display_multiple_scatter_plots_from_xy_series_list, '
                 + f'in source file, {CONSTANT_LOCAL_FILE_NAME},\n'
                 + f'was unable to display multiple scatter charts\n'
                 + f'for the caption, {caption_string}.')
...
#*******************************************************************************************
 #
 #  Subroutine Name:  display_pie_chart_from_series
 #
 #  Subroutine Description:
 #      This subroutine displays a pie chart from a series.
 #
 #
 #  Subroutine Parameters:
 #
 ...
 #  tuple
 #          explode_tuple
 #                          This parameter is the degree of separation for each pie wedge.
 #  boolean
 #          shadow_boolean
 #                          This parameter indicates whether the pie chart is shadowed.
 #  float
 #          pct_distance_float
...
def display_pie_chart_from_series \
    ...
    try:
        ...
        log_subroutines \
            .print_and_log_text \
                (f'The subroutine, display_pie_chart_from_series, '
                 + f'in source file, {CONSTANT_LOCAL_FILE_NAME},\n'
                 + f'with the caption, {caption_string},\n'
                 + f'was unable to plot a pie chart.')
